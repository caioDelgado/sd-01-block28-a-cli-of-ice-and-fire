...
describe('main menu', () => {
  describe('presented options', () => {
    ...
    function showOptions(type, contain) {
      test(`shows ${type} option`, () => {
        expect(choices).toContain(contain);
      });
    };
    
    showOptions('characters', 'Personagens');
    showOptions('books', 'Livros');
    showOptions('houses', 'Casas');
    showOptions('exit', 'Sair');
  });
